...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <div class="logo">
                <a href="Assets/images/background/inmasic1.jpeg"><?php echo $data['title']; ?></a>
            </div>
            <p class="auth-description"> ¡¡BIENVENIDO!! <br>CONECTATE Y COLABORA FACILMENTE.</p>

            <form id="formulario" autocomplete="off">
                <div class="auth-credentials m-b-xxl">
                    <label for="correo" class="form-label">Correo Electronico<span class="text-danger">*</span></label>
                    <input type="email" class="form-control m-b-md" id="correo" name="correo" aria-describedby="correo" placeholder="Correo Electronico" required>

                    <label for="clave" class="form-label">Contraseña<span class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="clave" name="clave" aria-describedby="clave" placeholder="Contraseña" required>
                </div>

                <div class="auth-submit">
                    <button type="submit" class="btn btn-primary">Acceso</button>
                    <!-- Agrego data-bs-toggle y data-bs-target para mostrar el modal -->
                    <a href="#" class="auth-forgot-password float-end" data-bs-toggle="modal" data-bs-target="#myModal">Olvidaste tu contraseña?</a>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input id="inputReset" class="form-control" type="text" name="inputReset" placeholder="Correo electrónico" required>
                    </div>
                </div>
